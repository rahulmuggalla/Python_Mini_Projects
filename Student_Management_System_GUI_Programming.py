import tkinter as tk #This is the tkinter module
from tkinter import ttk, messagebox #message box is used to display the saved message dialog box
import sqlite3 #inbuilt data base of python which is lite in nature and can handel low amount of data

root = tk.Tk()# making the object of the root class
root.title("Management")#the title function used to give title

connection = sqlite3.connect('management.db')#making the connection with the database
...
appLabel.config(font = ("Verdana", 30))#it is used for sizing the font
